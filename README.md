...
```bash
git clone https://github.com/Priyanshu84iya/Priyanshu-React-Portfolio
```
...
[LICENSE](https://github.com/Priyanshu84iya/Priyanshu-React-Portfolio/blob/main/LICENSE) for more details.
